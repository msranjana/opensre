...
class BedrockConverseAgentClient:
    ...
    def __init__(self, model: str, max_tokens: int = 4096) -> None:
        ...
        from services.bedrock_converse import require_aws_region
    ...
    def tool_schemas(self, tools: list[Any]) -> list[dict[str, Any]]:
        from services.bedrock_converse import build_converse_tool_specs
    ...
    @staticmethod
    def build_tool_result_message(tool_calls: list[ToolCall], results: list[Any]) -> dict[str, Any]:
        from services.bedrock_converse import build_tool_result_message as _build
...
def get_agent_llm() -> _AgentClientType:
    ...
    if provider == "openai":
        ...
        from services.llm_client import _is_anthropic_bedrock_model
